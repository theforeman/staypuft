...
roles = [
    {:name=>"Controller (Nova)",
     ...
     :services=>[:non_ha_qpid, :mysql, :non_ha_keystone, :nova_controller, :non_ha_glance, :cinder_controller, :heat, :ceilometer]},
    {:name=>"Compute (Nova)",
    ...
    {:name=>"Controller (Neutron)",
     ...
     :services=>[:non_ha_qpid, :mysql, :non_ha_keystone, :neutron_controller, :non_ha_glance, :cinder_controller, :heat, :ceilometer]},
